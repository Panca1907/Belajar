        ...
        <section className="bg-white text-black py-16">
          <div className="container mx-auto">
            ...
            <p className="text-lg">
              ...
              pengelolaan sampah anorganik yang efektif. Dengan sistem
              pembayaran yang aman dan mudah digunakan, Anda dapat membeli atau
              menjual sampah anorganik dengan percaya diri. Jaga lingkungan dan
              kesehatan manusia dengan bergabung bersama kami sekarang!
            </p>
          </div>
        </section>
